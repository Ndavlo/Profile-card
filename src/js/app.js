...
function render(variables = {}) {
  ...
  let name = `<div><h1>${variables.name} ${variables.lastname}</h1></div>`;
  if (variables.name == "") name = "<div></div>";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://linkedin.com/in/${variables.linkedin}"><i class="bi bi-linkedin"></i></a></li>
